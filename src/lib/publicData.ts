import type { LegacyUserDoc, Match, MatchStore, PendingInvite, PublicProfile, PublicStatsSummary } from "../types";
...
function normalizePublicProfile(raw: LegacyUserDoc = {}): PublicProfile {
  return {
...
function computePublicStats(data: MatchStore | null | undefined, playerName: string): PublicStatsSummary | null {
...
export { normalizePublicProfile, computePublicStats };
